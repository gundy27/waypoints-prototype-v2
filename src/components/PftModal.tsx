  ...
  return (
    <div className="absolute inset-0 z-[100] flex items-end justify-center">
      <button
        ...
        onClick={onClose}
        aria-label="Close PFT modal"
      />
      <div className="relative w-full bg-wp-surface rounded-t-2xl px-5 pt-5 pb-10">
        <div className="flex items-center justify-between mb-6">
          <h2 className="font-heading font-bold text-wp-black" style={{ fontSize: 18 }}>
            Log PFT Score
          </h2>
          <button type="button" onClick={onClose} className="p-2 -mr-2 bg-transparent border-none cursor-pointer">
        ...
        <div className="space-y-4">
          <div>
            <label htmlFor="pft_pullUps" className="block font-body font-medium text-wp-tan-dark mb-2" style={{ fontSize: 12, textTransform: 'uppercase', letterSpacing: '0.02em' }}>
              Pull-ups
            </label>
            <input
              id="pft_pullUps"
          ...
          <div>
            <label htmlFor="pft_crunches" className="block font-body font-medium text-wp-tan-dark mb-2" style={{ fontSize: 12, textTransform: 'uppercase', letterSpacing: '0.02em' }}>
              Crunches
            </label>
            <input
              id="pft_crunches"
          ...
          <div>
            <label htmlFor="pft_runMin" className="block font-body font-medium text-wp-tan-dark mb-2" style={{ fontSize: 12, textTransform: 'uppercase', letterSpacing: '0.02em' }}>
              3-Mile Run (mm:ss)
            </label>
