...
export default function PftModal({ onClose, onSubmit }: PftModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end justify-center bg-black/40" onClick={onClose}>
      <div
        className="w-full max-w-[428px] bg-wp-surface rounded-t-2xl p-5 pb-8"
      ...
      >
        <div className="flex items-center justify-between mb-5">
          ...
          <button onClick={onClose} className="p-2 bg-transparent border-none cursor-pointer">
        ...
        <div className="space-y-3">
          <div>
            ...
            <input
              ...
              placeholder="e.g. 20"
              className="w-full bg-wp-surface border-[1.5px] border-wp-contour rounded-lg px-4 font-body text-wp-black"
        ...
        {preview !== null && (
          <div className="mt-4 p-3 bg-wp-bg rounded-lg flex items-center justify-between">
